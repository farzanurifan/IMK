                      ...
                      <div class="row clearfix">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::text('namaseksi','$data->namaseksi',['class'=>'form-control', 'required', 'autofocus'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::text('kepalaseksi','$data->kepalaseksi',['class'=>'form-control', 'required'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row ">
                            ...
                            <div class="col-md-4 col-xs-4 col-sm-4 col-lg-4">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::text('nipkasek','$data->nipkasek',['class'=>'form-control', 'required'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
