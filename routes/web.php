...
Route::group(['prefix' => 'staf'], function(){
    ...
    Route::get('/namabidang', 'Staf\StafController@namabidang');
    Route::get('/namaseksi', 'Staf\StafController@namaseksi');
    ...
    Route::group(['prefix' => 'bidang'], function(){
        ...
        Route::get('/edit/1', 'Staf\BidangController@edit1');
        Route::get('/edit/2', 'Staf\BidangController@edit2');
    ...
    // Nama Bidang
    Route::group(['prefix' => 'namabidang'], function(){
        Route::get('/create', 'Staf\NamaBidangController@create');
        Route::post('/create/submit','Staf\NamaBidangController@create_submit');
        Route::get('/edit/1', 'Staf\NamaBidangController@edit1');
        Route::get('/edit/2', 'Staf\NamaBidangController@edit2');
        Route::put('/edit/submit','Staf\NamaBidangController@edit_submit');
        Route::delete('/delete/{id}', 'Staf\NamaBidangController@delete')->name('bidang.delete');
    });
    ...
    Route::group(['prefix' => 'seksi'], function(){
        ...
        Route::get('/edit/1', 'Staf\SeksiController@edit1');
        Route::get('/edit/2', 'Staf\SeksiController@edit2');
    ...
    // Nama Seksi
    Route::group(['prefix' => 'namaseksi'], function(){
        Route::get('/create', 'Staf\NamaSeksiController@create');
        Route::post('/create/submit','Staf\NamaSeksiController@create_submit');
        Route::get('/edit/1', 'Staf\NamaSeksiController@edit1');
        Route::get('/edit/2', 'Staf\NamaSeksiController@edit2');
        Route::put('/edit/submit','Staf\NamaSeksiController@edit_submit');
        Route::delete('/delete/{id}', 'Staf\NamaSeksiController@delete')->name('bidang.delete');
    });
    ...
    Route::group(['prefix' => 'staff'], function(){
        ...
        Route::get('/edit/1', 'Staf\StaffController@edit1');
        Route::get('/edit/2', 'Staf\StaffController@edit2');
